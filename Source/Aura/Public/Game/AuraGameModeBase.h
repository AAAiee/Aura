 ...
 *
 * The GameMode only exists on the SERVER ¡ª clients never have a GameMode instance.
 ...
 *
 * Currently no custom logic ¡ª all configuration is done in the Blueprint subclass.
 */
UCLASS()
